...
public class Blacksmith extends GameState {
	...
	public Blacksmith(TileMap tm , GameStateManager gsm, Player v, Inventory i) {
		super();
		this.gsm = gsm;
		tileMap = tm;
		player = v;
	...
	public void update() {
		...
		for(int i=0; i<7; i++){
			...
			if(i == 4) {scales.set(i,new float[]{ 2f, 2f, 2f, 1f});}
		}
